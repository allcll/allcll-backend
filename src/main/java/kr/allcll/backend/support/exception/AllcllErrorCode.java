...
public enum AllcllErrorCode {
    ...
    SEJONG_PRIVACY_CONSENT_REQUIRED(HttpStatus.UNAUTHORIZED, "세종대 포털에서 개인정보 수집동의를 먼저 완료해주세요."),
    ...
    OPERATION_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "해당 서비스 명을 찾을 수 없습니다."),
    CATEGORY_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "이수구분을 찾을 수 없습니다."),
