...
public class DoubleCreditCriteriaSheetValidator implements GraduationSheetValidator {

    public static final String TAB_KEY = "double-credit-criteria";
    ...
    public void validate(GraduationSheetTable sheetTable) {
        ...
        for (int rowIndex = 0; rowIndex < dataRows.size(); rowIndex++) {
            ...
            graduationSheetValidationSupport.requireString(TAB_KEY, sheetTable, dataRow, rowIndex, "primary_dept_cd");
            graduationSheetValidationSupport.requireString(TAB_KEY, sheetTable, dataRow, rowIndex, "primary_dept_nm");
            graduationSheetValidationSupport.requireString(TAB_KEY, sheetTable, dataRow, rowIndex, "secondary_dept_cd");
            graduationSheetValidationSupport.requireString(TAB_KEY, sheetTable, dataRow, rowIndex, "secondary_dept_nm");
