...
import kr.allcll.backend.external.ExternalProperties;
import kr.allcll.backend.seat.PinRemainSeat;
import kr.allcll.backend.seat.dto.SeatDto;
import kr.allcll.backend.seat.SeatStorage;
