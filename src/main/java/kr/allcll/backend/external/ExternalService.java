...
import kr.allcll.backend.basket.BasketRepository;
import kr.allcll.backend.exception.AllcllErrorCode;
import kr.allcll.backend.exception.AllcllException;
import kr.allcll.backend.external.dto.NonMajorRequest;
import kr.allcll.backend.external.dto.PinSubject;
import kr.allcll.backend.external.dto.PinSubjectsRequest;
import kr.allcll.backend.pin.Pin;
import kr.allcll.backend.pin.PinRepository;
import kr.allcll.backend.sse.SseEmitterStorage;
